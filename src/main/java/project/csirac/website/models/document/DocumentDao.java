...
public class DocumentDao {
    ...
    public Document findByName(String name) {
        return new Document(name, "How to use CSIRAC emulator in this web application. Step 1:According the guide from <a href=\"/Use_Guide/user_guide.pdf\">User Guide</a>, write down the instructions in the first blank and submit the program. Step 2: Input the data and submit. Step 3: When the monitor status shows 'Ready', Submit the frequency and Start the submitted program. If you want to pause at the process of the running program, press 'Pause' and revise the PCRegister if you want. Step 4: Continue the progress. Read the program memory history, register history and data memory history from the web. Step 5: stop the executing.", new Date());
    }
}
