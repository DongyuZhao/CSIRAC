System.register(["angular2/core", "../../../services/socket_services", "angular2/http"], function(exports_1) {
    ...
    var core_1, socket_services_1, http_1;
    var IoPanel;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            IoPanel = (function () {
                function IoPanel() {
                    this._ioClient = socket_services_1.SocketServices.clientFactory("emulator_in/io");
                    this._handShakeClient = socket_services_1.SocketServices.clientFactory("emulator_in/hand_shake");
                    this.program = "";
